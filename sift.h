...
//const double  POW_BASE =5.0;
#define   POW_BASE  5.0 

/*************************** Function Prototypes *****************************/
//void myFUCKFree(struct feature* feat,int nunmber);
/**
...
extern int One_sift_features( IplImage* img, struct feature** feat,int numberOfIntvls );
