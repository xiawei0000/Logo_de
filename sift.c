...
/*
  ...
  @param contr_thr low threshold on feature contrast  µÍ·§Öµ
  @param curv_thr high threshold on feature ratio of principal curvatures ¸ß·§Öµ
